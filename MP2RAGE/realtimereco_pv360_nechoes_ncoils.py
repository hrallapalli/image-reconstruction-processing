...
#    print phaseorder    
    ...
    a = np.array([2 * fidnum * phasenum * slicenum* nechoes], dtype = np.int32)
...
#    print(slicenum)
    ...
    a.resize((fidnum * phasenum * slicenum * nechoes),2)
...
#    a=np.reshape(acomplex[0:fidnum*phasenum*slicenum],(fidnum,phasenum,slicenum), order = 'F')
    a=np.reshape(acomplex,(readnum,nechoes,ncoils,phasenum,slicenum), order = 'F')
...
#    atrain1 = zeros(readnum, ncoils, phasenum, slicenum)
    atranspose = np.transpose(a,(0, 3, 4, 1, 2))
